...
My research interests lie in addressing the challenges of open-ended real-world tasks for multimodal large language models, including creativity, divergent thinking, proactive exploration, and bias mitigation. I am particularly interested in exploring AI applications in creative tasks, AI-assisted game design, emerging commercial applications of AI agents, and open-world exploration capabilities of embodied intelligence. <span style="color: #e74c3c; font-weight: bold;">My vision is to use AI to push beyond the boundaries of human knowledge and capabilities — to create, not replace.</span>

我的研究兴趣主要集中于探索多模态大语言模型在开放式真实世界任务中面临的关键挑战，包括创造力、发散性思维、主动探索能力以及偏差/长尾缓解等问题。我尤其关注人工智能在创意任务、辅助游戏设计、基于智能体的新兴商业应用，以及具身智能的开放世界探索能力等领域的应用。<span style="color: #e74c3c; font-weight: bold;">我的愿景是用AI突破人类知识与能力的边界，去创造而非替代。</span>

## About Me

I'm currently an Associate Professor at the Institute of AI for Engineering, Tongji University, working with [Prof. Xian-Sheng Hua](https://www.linkedin.com/in/xshua/). **My research group does not have an official name yet. For now, it can be referred to as [MReaL](https://mreallab.github.io/)@Tongji**. <span style="color: #e74c3c; font-weight: bold;"> If you are interested in joining us or collaborating with us, please contact（想加入我们或者与我们合作可以联系）: tangkaihua[at]tongji[dot]edu[dot]cn.</span>
...
I’ll share some interesting independent projects and games on the following webpage (欢迎通过下面链接关注我们的一些有趣项目): [link](https://kaihuatang.github.io/webcontainer/).
